...
- Composio Platform vs. For You routing, session/MCP least-privilege setup, and evidence requirements for first real calls: `references/composio-integration.md`
